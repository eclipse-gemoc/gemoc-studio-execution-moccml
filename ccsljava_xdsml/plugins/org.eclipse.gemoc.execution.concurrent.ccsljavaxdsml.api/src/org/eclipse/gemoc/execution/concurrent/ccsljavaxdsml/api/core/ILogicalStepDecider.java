...
public interface ILogicalStepDecider extends IDisposable
{
	 ...
	 */
	ParallelStep<?,?> decide(org.eclipse.gemoc.execution.concurrent.ccsljavaxdsml.api.core.AbstractConcurrentExecutionEngine<?, ?> engine, List<ParallelStep<?,?>> possibleLogicalSteps) throws DeciderException;
