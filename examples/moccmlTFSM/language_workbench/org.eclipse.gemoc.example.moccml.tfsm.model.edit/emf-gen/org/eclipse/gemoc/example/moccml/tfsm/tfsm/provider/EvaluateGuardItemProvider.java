...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.EvaluateGuard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvaluateGuardItemProvider extends GuardItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.EVALUATE_GUARD__CONDITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.EVALUATE_GUARD__CONDITION,
				 TfsmFactory.eINSTANCE.createOpaqueBooleanExpression()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.EVALUATE_GUARD__CONDITION,
				 TfsmFactory.eINSTANCE.createIntegerComparisonExpression()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.EVALUATE_GUARD__CONDITION,
				 TfsmFactory.eINSTANCE.createBooleanUnaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.EVALUATE_GUARD__CONDITION,
				 TfsmFactory.eINSTANCE.createBooleanBinaryExpression()));
	}
