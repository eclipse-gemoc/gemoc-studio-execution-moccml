...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.IntegerExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerExpression_operand2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerExpression_operand2_feature", "_UI_IntegerExpression_type"),
				 TfsmPackage.Literals.INTEGER_EXPRESSION__OPERAND2,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOperand1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerExpression_operand1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerExpression_operand1_feature", "_UI_IntegerExpression_type"),
				 TfsmPackage.Literals.INTEGER_EXPRESSION__OPERAND1,
				 true,
				 false,
				 true,
				 null,
