...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.BooleanBinaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERAND1,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERAND2,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
