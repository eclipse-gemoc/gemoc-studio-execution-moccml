...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.TRANSITION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.TRANSITION__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.TRANSITION__GENERATED_EVENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.TRANSITION__OWNED_GUARD);
			childrenFeatures.add(TfsmPackage.Literals.TRANSITION__ACTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TRANSITION__OWNED_GUARD,
				 TfsmFactory.eINSTANCE.createTemporalGuard()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TRANSITION__OWNED_GUARD,
				 TfsmFactory.eINSTANCE.createEventGuard()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TRANSITION__OWNED_GUARD,
				 TfsmFactory.eINSTANCE.createEvaluateGuard()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TRANSITION__ACTION,
				 TfsmFactory.eINSTANCE.createIntegerCalculationExpression()));
	}
