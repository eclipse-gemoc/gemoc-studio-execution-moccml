 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.impl.IntegerVariableImpl#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerVariableImpl extends VariableImpl implements IntegerVariable {
	...
	protected EClass eStaticClass() {
		return TfsmPackage.Literals.INTEGER_VARIABLE;
	}
	...
	public void setInitialValue(int newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.INTEGER_VARIABLE__INITIAL_VALUE, oldInitialValue, initialValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TfsmPackage.INTEGER_VARIABLE__INITIAL_VALUE:
