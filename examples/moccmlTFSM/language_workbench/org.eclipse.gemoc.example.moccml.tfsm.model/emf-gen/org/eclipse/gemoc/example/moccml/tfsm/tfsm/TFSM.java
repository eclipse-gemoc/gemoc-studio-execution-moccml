 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getOwnedStates <em>Owned States</em>}</li>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getInitialState <em>Initial State</em>}</li>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getLocalEvents <em>Local Events</em>}</li>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getLocalClock <em>Local Clock</em>}</li>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getOwnedTransitions <em>Owned Transitions</em>}</li>
 * </ul>
 *
 * @see org.eclipse.gemoc.example.moccml.tfsm.tfsm.TfsmPackage#getTFSM()
 * @model
 * @generated
 */
public interface TFSM extends NamedElement {
	 ...
	 * The list contents are of type {@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.State}.
	 * It is bidirectional and its opposite is '{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.State#getOwningFSM <em>Owning FSM</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.gemoc.example.moccml.tfsm.tfsm.TfsmPackage#getTFSM_InitialState()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getInitialState <em>Initial State</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.TFSM#getLocalClock <em>Local Clock</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
