 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.impl.StateImpl#getOwningFSM <em>Owning FSM</em>}</li>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.impl.StateImpl#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.impl.StateImpl#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends NamedElementImpl implements State {
	...
	public void setOwningFSM(TFSM newOwningFSM) {
		if (newOwningFSM != eInternalContainer() || (eContainerFeatureID() != TfsmPackage.STATE__OWNING_FSM && newOwningFSM != null)) {
			...
			if (newOwningFSM != null)
				msgs = ((InternalEObject)newOwningFSM).eInverseAdd(this, TfsmPackage.TFSM__OWNED_STATES, TFSM.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TfsmPackage.STATE__OWNING_FSM:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TFSM__OWNED_STATES, TFSM.class, msgs);
		}
