 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.example.moccml.tfsm.tfsm.impl.BooleanVariableImpl#isInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanVariableImpl extends VariableImpl implements BooleanVariable {
	...
	protected EClass eStaticClass() {
		return TfsmPackage.Literals.BOOLEAN_VARIABLE;
	}
	...
	public void setInitialValue(boolean newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.BOOLEAN_VARIABLE__INITIAL_VALUE, oldInitialValue, initialValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TfsmPackage.BOOLEAN_VARIABLE__INITIAL_VALUE:
