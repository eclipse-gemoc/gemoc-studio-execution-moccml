...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SigpmlPackage.Literals.APPLICATION__OWNED_AGENTS);
			childrenFeatures.add(SigpmlPackage.Literals.APPLICATION__OWNED_PLACES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SigpmlPackage.Literals.APPLICATION__OWNED_AGENTS,
				 SigpmlFactory.eINSTANCE.createAgent()));

		newChildDescriptors.add
			(createChildParameter
				(SigpmlPackage.Literals.APPLICATION__OWNED_PLACES,
				 SigpmlFactory.eINSTANCE.createPlace()));
	}
