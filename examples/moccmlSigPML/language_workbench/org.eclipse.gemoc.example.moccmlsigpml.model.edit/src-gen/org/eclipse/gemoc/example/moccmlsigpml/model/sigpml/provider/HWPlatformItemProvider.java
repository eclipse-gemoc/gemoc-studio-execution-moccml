...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.HWPlatform} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HWPlatformItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SigpmlPackage.Literals.HW_PLATFORM__OWNED_HW_RESOURCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SigpmlPackage.Literals.HW_PLATFORM__OWNED_HW_RESOURCES,
				 SigpmlFactory.eINSTANCE.createHWComputationalResource()));

		newChildDescriptors.add
			(createChildParameter
				(SigpmlPackage.Literals.HW_PLATFORM__OWNED_HW_RESOURCES,
				 SigpmlFactory.eINSTANCE.createHWStorageResource()));

		newChildDescriptors.add
			(createChildParameter
				(SigpmlPackage.Literals.HW_PLATFORM__OWNED_HW_RESOURCES,
				 SigpmlFactory.eINSTANCE.createHWCommunicationResource()));
	}
