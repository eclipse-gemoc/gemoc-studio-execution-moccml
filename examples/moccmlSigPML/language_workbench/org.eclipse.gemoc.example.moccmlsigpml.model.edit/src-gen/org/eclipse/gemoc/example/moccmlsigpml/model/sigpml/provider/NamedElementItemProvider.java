...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SigpmlPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedElement.class)) {
			case SigpmlPackage.NAMED_ELEMENT__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return SigpmlEditPlugin.INSTANCE;
	}
