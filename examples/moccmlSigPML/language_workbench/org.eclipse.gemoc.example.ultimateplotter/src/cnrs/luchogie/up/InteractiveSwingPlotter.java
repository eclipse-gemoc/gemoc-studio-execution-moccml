...
public class InteractiveSwingPlotter extends SwingPlotter
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3896698143440008834L;
	...
	private List<SwingPlotterListener> userSelectionList;
	...
	public List<SwingPlotterListener> getUserSelection()
	{
		return userSelectionList;
	}

	private void fireSelectionChanged(InteractiveSwingPlotter sp, Collection<Point> p)
	{
		Iterator<SwingPlotterListener> listeners = getListeners().iterator();
