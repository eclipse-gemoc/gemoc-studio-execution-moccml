...
public class SigpmlPackageImpl extends EPackageImpl implements SigpmlPackage {
	 ...
	 * @generated
	 */
	private EEnum agentStateEEnum = null;
	 ...
	 */
	@Override
	public EEnum getAgentState() {
		return agentStateEEnum;
	}
	...
	public void createPackageContents() {
		...
		// Create enums
		agentStateEEnum = createEEnum(AGENT_STATE);
	...
	public void initializePackageContents() {
		...
		initEEnum(agentStateEEnum, AgentState.class, "AgentState");
		addEEnumLiteral(agentStateEEnum, AgentState.INSTANTIATED);
		addEEnumLiteral(agentStateEEnum, AgentState.READING_INPUTS);
		addEEnumLiteral(agentStateEEnum, AgentState.EXECUTING);
		addEEnumLiteral(agentStateEEnum, AgentState.WRITING_OUTPUTS);
