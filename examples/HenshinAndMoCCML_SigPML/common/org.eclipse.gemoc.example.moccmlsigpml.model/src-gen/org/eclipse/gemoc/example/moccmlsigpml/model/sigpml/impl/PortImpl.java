 ...
 *   <li>{@link org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.impl.PortImpl#isHasBeenProcessed <em>Has Been Processed</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PortImpl extends NamedElementImpl implements Port {
	...
	/**
	 * The default value of the '{@link #isHasBeenProcessed() <em>Has Been Processed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isHasBeenProcessed()
	 * @generated
	 * @ordered
	 */
	protected static final boolean HAS_BEEN_PROCESSED_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isHasBeenProcessed() <em>Has Been Processed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isHasBeenProcessed()
	 * @generated
	 * @ordered
	 */
	protected boolean hasBeenProcessed = HAS_BEEN_PROCESSED_EDEFAULT;
	 ...
	 */
	@Override
	public void setHasBeenProcessed(boolean newHasBeenProcessed) {
		boolean oldHasBeenProcessed = hasBeenProcessed;
		hasBeenProcessed = newHasBeenProcessed;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlPackage.PORT__HAS_BEEN_PROCESSED, oldHasBeenProcessed, hasBeenProcessed));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SigpmlPackage.PORT__RATE:
				...
				return;
			case SigpmlPackage.PORT__HAS_BEEN_PROCESSED:
				setHasBeenProcessed((Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case SigpmlPackage.PORT__RATE:
				...
				return;
			case SigpmlPackage.PORT__HAS_BEEN_PROCESSED:
				setHasBeenProcessed(HAS_BEEN_PROCESSED_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SigpmlPackage.PORT__HAS_BEEN_PROCESSED:
				return hasBeenProcessed != HAS_BEEN_PROCESSED_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(" (rate: ");
		result.append(rate);
		result.append(", hasBeenProcessed: ");
		result.append(hasBeenProcessed);
		result.append(')');
