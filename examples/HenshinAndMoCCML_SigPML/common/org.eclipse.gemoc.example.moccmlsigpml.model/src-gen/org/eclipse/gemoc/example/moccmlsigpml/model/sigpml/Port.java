 ...
 *   <li>{@link org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.Port#isHasBeenProcessed <em>Has Been Processed</em>}</li>
 * </ul>
 *
...
public interface Port extends NamedElement {
	...
	/**
	 * Returns the value of the '<em><b>Has Been Processed</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Has Been Processed</em>' attribute.
	 * @see #setHasBeenProcessed(boolean)
	 * @see org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.SigpmlPackage#getPort_HasBeenProcessed()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gemoc.example.moccmlsigpml.model.sigpml.Port#isHasBeenProcessed <em>Has Been Processed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Has Been Processed</em>' attribute.
